        ...
        CustomForm(title: "Wi‑Fi") {
            Section {
                HStack(alignment: .top, spacing: 15) {
                    ...
                    Toggle(isOn: $WiFiEnabled) {
                        Text("Wi‑Fi")
                        Text("\("Set up Wi‑Fi to wirelessly connect your Mac to the internet. Turn on Wi‑Fi, then choose a network to join.") [\("Learn More…")](help:anchor=mchlp1180)")
                            .font(.callout)
                    }
                    .controlSize(.large)
                    .disabled(true)
            ...
            Section {
                ...
                Toggle(isOn: $askJoinHotspots) {
                    Text("Ask to join hotspots")
                    Text("Allow this Mac to automatically discover nearby personal hotspots when no Wi‑Fi network is available.")
                }
            } footer: {
                Button("Advanced…") {}
